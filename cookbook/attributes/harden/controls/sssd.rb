...
default['cookbook']['harden']['controls']['sssd'].tap do |control|
  control['sssd_auth_ca_db'].tap do |configuration|
    ...
    configuration['title'] = 'SV-258131: RHEL 9, for PKI-based authentication, must validate certificates by constructing a certification path (which includes status information) to an accepted trust anchor.'
